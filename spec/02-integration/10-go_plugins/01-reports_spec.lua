  ...
  describe("anonymous reports for go plugins #" .. strategy, function()
    ...
    lazy_setup(function()
      ...
      assert(helpers.start_kong({
        ...
        pluginserver_test_query_cmd = "go-pluginserver -plugins-directory /home/javier/devel/kong_dev/kong/spec/fixtures/go -dump-all-plugins",
        pluginserver_test_start_cmd = "go-pluginserver -plugins-directory /home/javier/devel/kong_dev/kong/spec/fixtures/go -kong-prefix /tmp",
